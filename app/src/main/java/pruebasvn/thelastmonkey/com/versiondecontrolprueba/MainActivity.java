    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSaludos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(),"Lenovo i5 segund",Toast.LENGTH_SHORT).show();
               Toast.makeText(MainActivity.this, "Toshiba i5 segundo", Toast.LENGTH_SHORT).show();
            }
        });
